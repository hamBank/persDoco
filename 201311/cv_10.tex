...
{Awarded for excellent management of the Department's mid-range database, infrastructure and web information sysystems}
%------------------------------------------------
\entry
{2007}
{Division head's Award}
{Corporate Stratigies Division, Department of the Environment}
{Awarded for excellentsupport to the Department's web information sysystems}
%------------------------------------------------
\end{entrylist}
